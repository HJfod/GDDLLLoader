...
class ButtonSprite : public cocos2d::CCMenuItem {
    public:
        static ButtonSprite* create(cocos2d::CCSprite* spr, cocos2d::CCMenu* targ, cocos2d::SEL_MenuHandler click);
};
...
class ButtonSpriteSpr : public cocos2d::CCSprite {
	public:
		...
		*/
		static ButtonSpriteSpr* create(const char* caption, int width, bool absolute, const char* font, const char* texture, float height, float scale) {
			...
			auto pRet = reinterpret_cast<ButtonSpriteSpr* (__fastcall*)(const char*, int, int, bool, const char*, const char*, float)>(
				GetModuleHandleA(0) + 0x137D0
