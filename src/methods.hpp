...
namespace methods {
    ...
    void fsaveb (std::string _path, const char* _bytes) {
        std::ofstream file;
    ...
    std::string xts (rapidxml::xml_node<>* _xml, int flags = 0) {
        std::string res;
        rapidxml::print(std::back_inserter(res), *_xml, flags);
        return res;
    }

    std::string xts (rapidxml::xml_document<>* _xml, int flags = 0) {
        std::string res;
        rapidxml::print(std::back_inserter(res), *_xml, flags);
        return res;
    }
    ...
    std::string hexstr(int _i) {
        std::stringstream ss;
        ss << std::hex << _i << std::dec;
        return ss.str();
    }
